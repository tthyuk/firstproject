        ...
        "INFJ": {
            ...
            "good_combinations": [
                {"type": "ENFP", "reason": "INFJ와 ENFP는 감성적 유대감을 형성하며 영화의 깊은 의미를 함께 탐구하고 감정을 공유합니다.",
                 "combination_movie_recommendations": [
                     {"title": "Eternal Sunshine of the Spotless Mind (2004) 💔", "description": "기억과 사랑, 관계의 본질을 탐구하는 독특한 SF 로맨스. INFJ와 ENFP는 영화 속 상징과 은유, 그리고 복잡한 감정선에 대해 깊이 있는 대화를 나누며 서로의 통찰력을 공유할 수 있습니다."}
                 ]},
                {"type": "ENTP", "reason": "ENTP의 논리적인 분석과 INFJ의 통찰력이 만나 영화에 대한 풍부하고 다각적인 대화를 이끌어낼 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "Inception (2010) 💭", "description": "꿈속으로 들어가 생각을 훔치거나 심는 복잡한 개념의 SF 스릴러. ENTP의 논리적 분석과 INFJ의 통찰력이 결합하여 영화의 복잡한 구조와 철학적 의미를 파헤치며 지적인 자극을 주고받을 수 있습니다."}
                 ]}
            ]
        },
        "INTJ": {
            ...
            "good_combinations": [
                {"type": "INTP", "reason": "INTJ와 INTP는 모두 논리적이고 분석적인 사고를 선호하여 영화의 과학적, 철학적 의미에 대해 깊이 있는 토론을 할 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "Coherence (2013) 🌌", "description": "혜성이 지구에 접근하면서 벌어지는 기이한 현상과 다중 우주를 다룬 저예산 SF 스릴러. INTJ와 INTP는 영화의 복잡한 플롯과 예측 불가능한 전개, 그리고 숨겨진 과학적, 철학적 의미에 대해 밤새도록 토론할 수 있습니다."}
                 ]},
                {"type": "ENFP", "reason": "ENFP의 창의적이고 감성적인 관점이 INTJ의 논리적 사고에 새로운 영감을 주어 영화를 더 다채롭게 이해할 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "Gattaca (1997) 🧬", "description": "유전자 조작이 보편화된 미래 사회에서 자연적으로 태어난 한 남자가 우주 비행의 꿈을 이루기 위해 노력하는 이야기. INTJ는 영화의 사회 구조와 윤리적 딜레마를 분석하고, ENFP는 꿈을 향한 열정과 인간 정신의 아름다움에 공감하며, 서로의 관점을 풍부하게 나눌 수 있습니다."}
                 ]}
            ]
        },
        "ISTP": {
            ...
            "good_combinations": [
                {"type": "ESFP", "reason": "ISTP의 논리적이고 실용적인 면모와 ESFP의 활동적이고 즉흥적인 면모가 결합하여 영화에 대한 흥미로운 관점과 즉각적인 반응을 공유할 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "Jumanji: Welcome to the Jungle (2017) 🌴", "description": "비디오 게임 속으로 빨려 들어간 주인공들이 각자의 특수 능력을 활용해 미션을 해결하는 어드벤처 코미디. ISTP는 게임의 규칙과 퍼즐 해결에 집중하고, ESFP는 영화의 유머와 캐릭터들의 활기찬 상호작용을 즐기며 함께 즐거운 시간을 보낼 수 있습니다."}
                 ]},
                {"type": "ENTP", "reason": "ENTP의 창의적인 아이디어와 ISTP의 문제 해결 능력이 시너지를 내어 영화의 복잡한 설정이나 과학적 원리에 대해 깊이 있는 대화를 나눌 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "Now You See Me (2013) 🎩", "description": "천재 마술사들이 펼치는 화려한 마술과 그 안에 숨겨진 치밀한 계획을 다룬 범죄 스릴러. ISTP는 마술의 트릭과 실용적인 실행 방식에 흥미를 느끼고, ENTP는 마술의 독창적인 아이디어와 숨겨진 계획을 분석하며 서로에게 지적인 자극을 줄 수 있습니다."}
                 ]}
            ]
        },
        "ISFP": {
            ...
            "good_combinations": [
                {"type": "ENFJ", "reason": "ENFJ의 따뜻하고 지지적인 성향이 ISFP의 감수성과 어우러져 영화 속 인물들의 감정을 깊이 있게 공감하며 대화할 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "Dead Poets Society (1989) 📚", "description": "전통적인 학교에 부임한 자유로운 영혼의 영문학 선생님이 학생들에게 삶의 새로운 의미를 가르치는 이야기. ISFP는 영화의 예술적이고 감성적인 표현에 공감하고, ENFJ는 선생님의 리더십과 학생들에게 주는 긍정적인 영향에 깊이 몰입하며, 함께 감동과 영감을 나눌 수 있습니다."}
                 ]},
                {"type": "INFP", "reason": "ISFP와 INFP는 비슷한 감성적 깊이를 가지고 있어 영화가 전달하는 메시지나 감동을 함께 느끼고 나눌 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "Big Fish (2003) 🐠", "description": "과장된 이야기 속에서 아버지의 진정한 삶의 의미를 찾아가는 아들의 여정을 그린 환상적인 영화. ISFP의 예술적인 감각과 INFP의 이상주의가 만나 영화의 아름다운 영상미와 깊이 있는 상징, 그리고 삶의 진정한 의미에 대해 풍부하게 공감하고 나눌 수 있습니다."}
                 ]}
            ]
        },
        "INFP": {
            ...
            "good_combinations": [
                {"type": "ENFP", "reason": "INFP와 ENFP는 모두 이상주의적이고 감수성이 풍부하여 영화의 숨겨진 의미나 감성적인 부분에 대해 깊이 있는 대화를 나눌 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "About Time (2013) ⏳", "description": "시간 여행 능력을 가진 남자가 사랑과 삶의 의미를 찾아가는 과정을 그린 로맨스 판타지. INFP와 ENFP는 영화가 선사하는 따뜻한 감동과 삶의 소중함, 그리고 시간에 대한 철학적인 메시지에 깊이 공감하며 서로의 감성을 풍부하게 나눌 수 있습니다."}
                 ]},
                {"type": "INFJ", "reason": "INFJ의 통찰력과 INFP의 이상주의가 만나 영화의 철학적 메시지에 대해 심도 깊은 논의를 할 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "Life of Pi (2012) 🐅", "description": "난파선에서 홀로 남은 소년과 호랑이의 생존기를 다룬 철학적인 모험 영화. INFP의 이상주의와 INFJ의 통찰력이 만나 영화의 종교적, 철학적 의미와 인간 존재에 대한 깊은 질문에 대해 심도 깊은 대화를 나눌 수 있습니다."}
                 ]}
            ]
        },
        "INTP": {
            ...
            "good_combinations": [
                ...
                {"type": "ENTP", "reason": "비슷한 지적 호기심과 논리적 탐구심을 공유하여 영화의 복잡한 주제에 대해 흥미로운 대화를 나눌 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "The Social Network (2010) 💻", "description": "페이스북의 탄생과정과 그 이면에 숨겨진 창립자들의 갈등을 다룬 영화. INTP와 ENTP는 영화 속 기술적 혁신, 사업 전략, 그리고 인물 간의 법적, 윤리적 논쟁에 대해 깊이 분석하고 활발하게 토론할 수 있습니다."}
                 ]}
            ]
        },
        "ESTP": {
            ...
            "good_combinations": [
                {"type": "ESFP", "reason": "ISTP의 논리적이고 실용적인 면모와 ESFP의 활동적이고 즉흥적인 면모가 결합하여 영화에 대한 흥미로운 관점과 즉각적인 반응을 공유할 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "Jumanji: Welcome to the Jungle (2017) 🌴", "description": "비디오 게임 속으로 빨려 들어간 주인공들이 각자의 특수 능력을 활용해 미션을 해결하는 어드벤처 코미디. ESTP는 게임의 규칙과 즉각적인 문제 해결에 집중하고, ESFP는 영화의 유머와 캐릭터들의 활기찬 상호작용을 즐기며 함께 즐거운 시간을 보낼 수 있습니다."}
                 ]},
                {"type": "ENTJ", "reason": "ENTJ의 전략적인 사고와 ESTP의 실행력이 결합하여 영화의 주제나 전개에 대해 활발하고 생산적인 대화를 나눌 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "The Big Short (2015) 💰", "description": "2008년 금융 위기를 예측하고 월스트리트에 맞서 성공을 거둔 사람들의 이야기. ESTP의 현실적인 관찰력과 ENTJ의 전략적인 사고가 만나 복잡한 경제 시스템과 인간의 탐욕에 대해 깊이 분석하고 논의할 수 있습니다."}
                 ]}
            ]
        },
        "ESFP": {
            ...
            "good_combinations": [
                {"type": "ISFJ", "reason": "ESFP의 밝은 에너지와 ISFJ의 차분하고 배려심 깊은 성향이 어우러져 편안하고 즐거운 영화 감상 분위기를 만듭니다.",
                 "combination_movie_recommendations": [
                     {"title": "The Blind Side (2009) 🏈", "description": "역경을 딛고 꿈을 이루는 한 소년과 그를 지원하는 가족의 감동 실화. ESFP의 긍정적이고 활동적인 에너지가 ISFJ의 헌신적인 보살핌과 만나 영화의 따뜻한 메시지에 깊이 공감하고 즐길 수 있습니다."}
                 ]},
                {"type": "ENFP", "reason": "ESFP와 ENFP는 비슷한 낙천적이고 사교적인 성향으로 영화에 대한 활발한 감정 공유와 재미있는 대화를 나눌 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "About Time (2013) ⏳", "description": "시간 여행 능력을 가진 남자가 사랑과 삶의 의미를 찾아가는 과정을 그린 로맨스 판타지. ESFP는 영화의 따뜻한 감성과 유머를 즐기고, ENFP는 시간과 삶의 의미에 대한 깊이 있는 통찰을 공유하며 함께 풍부한 감정을 나눌 수 있습니다."}
                 ]}
            ]
        },
        "ENFP": {
            ...
            "good_combinations": [
                {"type": "INFJ", "reason": "ENFP의 열정적인 아이디어와 INFJ의 통찰력이 만나 영화의 깊은 의미와 숨겨진 메시지에 대해 풍부한 대화를 나눌 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "Eternal Sunshine of the Spotless Mind (2004) 💔", "description": "기억과 사랑, 관계의 본질을 탐구하는 독특한 SF 로맨스. ENFP와 INFJ는 영화 속 상징과 은유, 그리고 복잡한 감정선에 대해 깊이 있는 대화를 나누며 서로의 통찰력을 공유할 수 있습니다."}
                 ]},
                {"type": "INTJ", "reason": "INTJ의 논리적이고 분석적인 관점에 ENFP의 창의적인 사고가 더해져 영화를 다각도로 해석하고 새로운 관점을 공유할 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "Gattaca (1997) 🧬", "description": "유전자 조작이 보편화된 미래 사회에서 자연적으로 태어난 한 남자가 우주 비행의 꿈을 이루기 위해 노력하는 이야기. ENFP는 꿈을 향한 열정과 인간 정신의 아름다움에 공감하고, INTJ는 영화의 사회 구조와 윤리적 딜레마를 분석하며, 서로의 관점을 풍부하게 나눌 수 있습니다."}
                 ]}
            ]
        },
        "ENTP": {
            ...
            "good_combinations": [
                {"type": "INTP", "reason": "ENTP와 INTP는 모두 지적인 호기심과 논리적 탐구심이 강하여 영화의 복잡한 주제나 과학적 원리에 대해 심도 깊은 대화를 나눌 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "The Social Network (2010) 💻", "description": "페이스북의 탄생과정과 그 이면에 숨겨진 창립자들의 갈등을 다룬 영화. ENTP와 INTP는 영화 속 기술적 혁신, 사업 전략, 그리고 인물 간의 법적, 윤리적 논쟁에 대해 깊이 분석하고 활발하게 토론할 수 있습니다."}
                 ]},
        ...
        "ESTJ": {
            ...
            "good_combinations": [
                {"type": "ISTJ", "reason": "ESTJ와 ISTJ는 모두 현실적이고 체계적인 사고를 선호하여 영화의 사실적 배경이나 논리적 전개에 대해 깊은 공감대를 형성하며 감상할 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "Contagion (2011) 🦠", "description": "치명적인 전염병의 확산과 이를 막기 위한 전 세계적인 노력, 그리고 사회 시스템의 반응을 현실적으로 그린 영화. ESTJ와 ISTJ 모두 위기 상황에서의 체계적인 대응과 효율적인 문제 해결 방식에 대해 깊이 공감하고 논의할 수 있습니다."}
                 ]},
                {"type": "ENTJ", "reason": "ENTJ와 ESTJ는 강력한 리더십과 목표 지향적인 성향을 공유하여 영화 속 전략이나 효율성에 대해 활발한 논의를 할 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "The Big Short (2015) 💰", "description": "2008년 금융 위기를 예측하고 월스트리트에 맞서 성공을 거둔 사람들의 이야기. ESTJ의 현실적이고 실용적인 관점과 ENTJ의 전략적이고 비판적인 분석이 만나 복잡한 경제 시스템과 인간의 탐욕에 대해 깊이 논의할 수 있습니다."}
                 ]}
            ]
        },
        "ESFJ": {
            ...
            "good_combinations": [
                {"type": "ISFJ", "reason": "ESFJ와 ISFJ는 모두 사람들과의 조화를 중요하게 생각하고 따뜻한 마음을 가지고 있어, 영화 속 감동적인 스토리에 깊이 공감하며 함께 즐거운 시간을 보낼 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "Green Book (2018) 🚗", "description": "1960년대 미국 남부를 배경으로 한 흑인 피아니스트와 이탈리아계 운전사의 특별한 우정을 그린 영화. ESFJ와 ISFJ는 영화 속 인물들의 따뜻한 관계 변화와 사회적 메시지에 깊이 공감하며, 서로의 감정을 공유하고 나눌 수 있습니다."}
                 ]},
                {"type": "ENFJ", "reason": "ENFJ의 리더십과 ESFJ의 협력적인 태도가 만나 영화에 대한 감상평을 활발하게 나누고 서로에게 긍정적인 영향을 줄 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "Remember the Titans (2000) 🏈", "description": "인종 차별이 심했던 시기에 통합 미식축구팀을 이끌며 역경을 극복하는 감동 실화. ESFJ와 ENFJ는 영화 속 리더십, 팀워크, 그리고 사회적 화합의 메시지에 깊이 공감하며 함께 영감을 얻고 긍정적인 대화를 나눌 수 있습니다."}
                 ]}
            ]
        },
        "ENFJ": {
            ...
            "good_combinations": [
                {"type": "INFP", "reason": "ENFJ의 따뜻하고 지지적인 성향과 INFP의 감성적인 깊이가 만나 영화에 대한 감정을 풍부하게 공유하고 서로에게 긍정적인 영향을 줄 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "Life of Pi (2012) 🐅", "description": "난파선에서 홀로 남은 소년과 호랑이의 생존기를 다룬 철학적인 모험 영화. ENFJ는 영화 속에서 발견할 수 있는 희망과 용기의 메시지에 공감하고, INFP는 영화의 아름다운 영상미와 깊이 있는 철학적, 종교적 의미에 몰입하며 서로의 감성과 통찰을 풍부하게 나눌 수 있습니다."}
                 ]},
                {"type": "ESFJ", "reason": "비슷하게 사교적이고 협력적인 성향으로 영화 감상 후 활발한 대화를 나누며 즐거움을 배가시킬 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "Remember the Titans (2000) 🏈", "description": "인종 차별이 심했던 시기에 통합 미식축구팀을 이끌며 역경을 극복하는 감동 실화. ENFJ와 ESFJ는 영화 속 리더십, 팀워크, 그리고 사회적 화합의 메시지에 깊이 공감하며 함께 영감을 얻고 긍정적인 대화를 나눌 수 있습니다."}
                 ]}
            ]
        },
        "ENTJ": {
            ...
            "good_combinations": [
                {"type": "INTP", "reason": "ENTJ의 리더십과 INTP의 깊은 분석력이 결합하여 영화의 복잡한 주제나 숨겨진 의미에 대해 심도 있는 토론을 할 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "The Social Network (2010) 💻", "description": "페이스북의 탄생과정과 그 이면에 숨겨진 창립자들의 갈등을 다룬 영화. ENTJ의 전략적 사고와 INTP의 깊은 분석력이 만나 영화 속 혁신, 사업 전략, 그리고 인물 간의 법적, 윤리적 논쟁에 대해 활발하게 토론할 수 있습니다."}
                 ]},
                {"type": "ESTJ", "reason": "비슷하게 목표 지향적이고 효율성을 중시하는 성향으로 영화의 전개나 전략적 요소에 대해 깊이 공감하며 활발한 대화를 나눌 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "The Big Short (2015) 💰", "description": "2008년 금융 위기를 예측하고 월스트리트에 맞서 성공을 거둔 사람들의 이야기. ENTJ와 ESTJ는 영화 속 복잡한 경제 시스템을 분석하고, 위기 속에서 효율적인 전략을 세우는 과정을 보며 깊이 공감하고 논의할 수 있습니다."}
                 ]}
            ]
        }
    }
