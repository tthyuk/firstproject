...
def main():
    ...
    mbti_recommendations_full = {
        ...
        "ISFJ": {
            ...
            "movies": [
                {"title": "Hidden Figures (2016) 👩‍🔬", # 연도 수정 (2016 -> 2016) - 실제 영화 연도는 2016년입니다.
        ...
        "INTJ": {
            ...
            "good_combinations": [
                ...
                {"type": "ENFP", "reason": "ENFP의 창의적이고 감성적인 관점이 INTJ의 논리적 사고에 새로운 영감을 주어 영화를 더 다채롭게 이해할 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "Gattaca (1997) 🧬", "description": "유전자 조작이 보편화된 미래 사회에서 자연적으로 태어난 한 남자가 우주 비행의 꿈을 이루기 위해 노력하는 이야기. INTJ는 영화의 사회 구조와 윤리적 딜레마를 분석하고, ENFP는 꿈을 향한 열정과 인간 정신의 아름다움을에 공감하며, 서로의 관점을 풍부하게 나눌 수 있습니다."}
                 ]}
            ]
        },
        "ISTP": {
        ...
        "ISFP": {
            ...
            "movies": [
                ...
                {"title": "Hidden Figures (2016) 👩‍🔬", # 연도 수정 (2016)
        ...
        "ENFP": {
            ...
            "good_combinations": [
                ...
                {"type": "INTJ", "reason": "INTJ의 논리적이고 분석적인 관점에 ENFP의 창의적인 사고가 더해져 영화를 다각도로 해석하고 새로운 관점을 공유할 수 있습니다.",
                 "combination_movie_recommendations": [
                     {"title": "Gattaca (1997) 🧬", "description": "유전자 조작이 보편화된 미래 사회에서 자연적으로 태어난 한 남자가 우주 비행의 꿈을 이루기 위해 노력하는 이야기. ENFP는 꿈을 향한 열정과 인간 정신의 아름다움을에 공감하고, INTJ는 영화의 사회 구조와 윤리적 딜레마를 분석하며, 서로의 관점을 풍부하게 나눌 수 있습니다."}
                 ]}
            ]
        },
        "ENTP": {
